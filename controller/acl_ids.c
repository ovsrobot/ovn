                                 ...
                                 struct tracked_acl_ids *tracked_acl_ids)
{
     ...
     * tracked_acl_ids may be NULL. It shouldn't happen since the ofctrl
     * state machine has to advance to the point that it can even call this
     * function, but this is a safeguard.
     */
    if (!tracked_acl_ids) {
        return false;
    }
