...
/* Callback to be used by callers of 'ne_nl_sync_neigh' in order to
 * filter what neighbor entries should be learned.  It must return 'true'
 * in those cases and 'false' otherwise. */
typedef bool ne_nl_neigh_filter(const struct ne_nl_received_neigh *);
